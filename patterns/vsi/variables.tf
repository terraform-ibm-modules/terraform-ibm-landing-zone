...
variable "existing_ssh_key_name" {
  description = "The name of a public SSH Key which already exists in the deployment region that will be used for VSI creation. To add a new SSH key, use the variable 'ssh_public_key'."
  type        = string
  default     = null
}
