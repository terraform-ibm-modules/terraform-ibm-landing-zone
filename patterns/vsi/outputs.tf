...
output "management_rg_id" {
  ...
  value       = module.vsi_landing_zone.management_rg_name != null ? module.vsi_landing_zone.resource_group_data[module.vsi_landing_zone.management_rg_name] : null
}
...
output "workload_rg_id" {
  ...
  value       = module.vsi_landing_zone.workload_rg_name != null ? module.vsi_landing_zone.resource_group_data[module.vsi_landing_zone.workload_rg_name] : null
}
