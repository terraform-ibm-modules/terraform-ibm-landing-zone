...
locals {
  ...
  env = {
    ...
    f5_template_data = {
      tmos_admin_password     = lookup(local.override[local.override_type], "f5_template_data", null) == null ? var.tmos_admin_password : lookup(local.override.f5_template_data, "tmos_admin_password", var.tmos_admin_password)
      license_type            = lookup(local.override[local.override_type], "f5_template_data", null) == null ? var.license_type : lookup(local.override.f5_template_data, "license_type", var.license_type)
      byol_license_basekey    = lookup(local.override[local.override_type], "f5_template_data", null) == null ? var.byol_license_basekey : lookup(local.override.f5_template_data, "byol_license_basekey", var.byol_license_basekey)
      license_host            = lookup(local.override[local.override_type], "f5_template_data", null) == null ? var.license_host : lookup(local.override.f5_template_data, "license_host", var.license_host)
      license_username        = lookup(local.override[local.override_type], "f5_template_data", null) == null ? var.license_username : lookup(local.override.f5_template_data, "license_username", var.license_username)
      license_password        = lookup(local.override[local.override_type], "f5_template_data", null) == null ? var.license_password : lookup(local.override.f5_template_data, "license_password", var.license_password)
      license_pool            = lookup(local.override[local.override_type], "f5_template_data", null) == null ? var.license_pool : lookup(local.override.f5_template_data, "license_pool", var.license_pool)
      license_sku_keyword_1   = lookup(local.override[local.override_type], "f5_template_data", null) == null ? var.license_sku_keyword_1 : lookup(local.override.f5_template_data, "license_sku_keyword_1", var.license_sku_keyword_1)
      license_sku_keyword_2   = lookup(local.override[local.override_type], "f5_template_data", null) == null ? var.license_sku_keyword_2 : lookup(local.override.f5_template_data, "license_sku_keyword_2", var.license_sku_keyword_2)
      license_unit_of_measure = lookup(local.override[local.override_type], "f5_template_data", null) == null ? var.license_unit_of_measure : lookup(local.override.f5_template_data, "license_unit_of_measure", var.license_unit_of_measure)
      do_declaration_url      = lookup(local.override[local.override_type], "f5_template_data", null) == null ? var.do_declaration_url : lookup(local.override.f5_template_data, "do_declaration_url", var.do_declaration_url)
      as3_declaration_url     = lookup(local.override[local.override_type], "f5_template_data", null) == null ? var.as3_declaration_url : lookup(local.override.f5_template_data, "as3_declaration_url", var.as3_declaration_url)
      ts_declaration_url      = lookup(local.override[local.override_type], "f5_template_data", null) == null ? var.ts_declaration_url : lookup(local.override.f5_template_data, "ts_declaration_url", var.ts_declaration_url)
      phone_home_url          = lookup(local.override[local.override_type], "f5_template_data", null) == null ? var.phone_home_url : lookup(local.override.f5_template_data, "phone_home_url", var.phone_home_url)
      template_source         = lookup(local.override[local.override_type], "f5_template_data", null) == null ? var.template_source : lookup(local.override.f5_template_data, "template_source", var.template_source)
      template_version        = lookup(local.override[local.override_type], "f5_template_data", null) == null ? var.template_version : lookup(local.override.f5_template_data, "template_version", var.template_version)
      app_id                  = lookup(local.override[local.override_type], "f5_template_data", null) == null ? var.app_id : lookup(local.override.f5_template_data, "app_id", var.app_id)
      tgactive_url            = lookup(local.override[local.override_type], "f5_template_data", null) == null ? var.tgactive_url : lookup(local.override.f5_template_data, "tgactive_url", var.tgactive_url)
      tgstandby_url           = lookup(local.override[local.override_type], "f5_template_data", null) == null ? var.tgstandby_url : lookup(local.override.f5_template_data, "tgstandby_url", var.tgstandby_url)
      tgrefresh_url           = lookup(local.override[local.override_type], "f5_template_data", null) == null ? var.tgrefresh_url : lookup(local.override.f5_template_data, "tgrefresh_url", var.tgrefresh_url)
    }
    teleport_vsi = lookup(local.override[local.override_type], "teleport_vsi", local.config.teleport_vsi)
    teleport_config = {
      teleport_license   = lookup(local.override[local.override_type], "teleport_config", null) == null ? local.config.teleport_config.teleport_license : lookup(local.override.teleport_config, "teleport_license", local.config.teleport_config.teleport_license)
      https_cert         = lookup(local.override[local.override_type], "teleport_config", null) == null ? local.config.teleport_config.https_cert : lookup(local.override.teleport_config, "https_cert", local.config.teleport_config.https_cert)
      https_key          = lookup(local.override[local.override_type], "teleport_config", null) == null ? local.config.teleport_config.https_key : lookup(local.override.teleport_config, "https_key", local.config.teleport_config.https_key)
      domain             = lookup(local.override[local.override_type], "teleport_config", null) == null ? local.config.teleport_config.domain : lookup(local.override.teleport_config, "domain", local.config.teleport_config.domain)
      cos_bucket_name    = lookup(local.override[local.override_type], "teleport_config", null) == null ? local.config.teleport_config.cos_bucket_name : lookup(local.override.teleport_config, "cos_bucket_name", local.config.teleport_config.cos_bucket_name)
      cos_key_name       = lookup(local.override[local.override_type], "teleport_config", null) == null ? local.config.teleport_config.cos_key_name : lookup(local.override.teleport_config, "cos_key_name", local.config.teleport_config.cos_key_name)
      teleport_version   = lookup(local.override[local.override_type], "teleport_config", null) == null ? local.config.teleport_config.teleport_version : lookup(local.override.teleport_config, "teleport_version", local.config.teleport_config.teleport_version)
      message_of_the_day = lookup(local.override[local.override_type], "teleport_config", null) == null ? local.config.teleport_config.message_of_the_day : lookup(local.override.teleport_config, "message_of_the_day", local.config.teleport_config.message_of_the_day)
      app_id_key_name    = lookup(local.override[local.override_type], "teleport_config", null) == null ? local.config.teleport_config.app_id_key_name : lookup(local.override.teleport_config, "app_id_key_name", local.config.teleport_config.app_id_key_name)
      hostname           = lookup(local.override[local.override_type], "teleport_config", null) == null ? local.config.teleport_config.hostname : lookup(local.override.teleport_config, "hostname", local.config.teleport_config.hostname)
      claims_to_roles    = lookup(local.override[local.override_type], "teleport_config", null) == null ? local.config.teleport_config.claims_to_roles : lookup(local.override.teleport_config, "claims_to_roles", local.config.teleport_config.claims_to_roles)
    }
