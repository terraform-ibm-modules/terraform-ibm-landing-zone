...
output "management_rg_id" {
  ...
  value       = module.landing_zone.management_rg_name != null ? module.landing_zone.resource_group_data[module.landing_zone.management_rg_name] : null
}
...
output "workload_rg_id" {
  ...
  value       = module.landing_zone.workload_rg_name != null ? module.landing_zone.resource_group_data[module.landing_zone.workload_rg_name] : null
}
