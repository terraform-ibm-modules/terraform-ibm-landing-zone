...
output "service_authorization_names" {
  description = "List of service authorization names"
  value       = module.roks_landing_zone.service_authorization_names
}


output "service_authorization_data" {
  description = "List of service authorization data"
  value = module.roks_landing_zone.service_authorization_data
}

output "authorization_policies" {
  description = "authorization_policies"
  value = module.roks_landing_zone.authorization_policies
}

output "policy_name" {
  description = "policy name"
  value = module.roks_landing_zone.policy_name
}