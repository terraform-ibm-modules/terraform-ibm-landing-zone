...
output "service_authorization_names" {
  ...
  value       = module.vpc_landing_zone.service_authorization_names
}


output "service_authorization_data" {
  description = "List of service authorization data"
  value = module.vpc_landing_zone.service_authorization_data
}

output "authorization_policies" {
  value = module.vpc_landing_zone.authorization_policies
}

output "policy_name" {
  value = module.vpc_landing_zone.policy_name
}