...
resource "ibm_container_vpc_cluster" "cluster" {
  ...
  disable_outbound_traffic_protection = (lookup(each.value, "kube_version", null) == "default" || lookup(each.value, "kube_version", null) == null ? local.default_kube_version[each.value.kube_type] : each.value.kube_version) == "4.12_openshift" || (lookup(each.value, "kube_version", null) == "default" || lookup(each.value, "kube_version", null) == null ? local.default_kube_version[each.value.kube_type] : each.value.kube_version) == "4.13_openshift" || (lookup(each.value, "kube_version", null) == "default" || lookup(each.value, "kube_version", null) == null ? local.default_kube_version[each.value.kube_type] : each.value.kube_version) == "4.14_openshift" ? null : each.value.disable_outbound_traffic_protection
