...
| <a name="input_create_s2s_authorization_policy"></a> [create\_s2s\_authorization\_policy](#input\_create\_s2s\_authorization\_policy) | Set it to true to create the authorization policy. | `bool` | `true` | no |
