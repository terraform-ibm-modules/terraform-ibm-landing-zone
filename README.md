...
Each of these patterns creates the following infrastructure:sssddd
...
Each pattern creates the following infrastructure on the VPC:dss
...
- The mixed pattern provisions botdh of these elementsss
